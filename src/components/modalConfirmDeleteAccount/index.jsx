    ...
    getInfos()
      .then((res) => {
        ...
        if (res) {
          ...
          const _ref = ref(db, `users/${userId}/accounts`);

          if (_data[selectedAccount?.id]) {
            delete _data[selectedAccount?.id];
          }
      ...
      >
        ...
        <ModalBody>
          ...
          <div className="item-infos">
            <div>
              <b>Nome da conta:</b> {selectedAccount?.name}
            </div>
            <div>
              <b>Saldo:</b> {selectedAccount?.balance}
            </div>
          </div>
        </ModalBody>
        <ModalFooter>
...
export default injectIntl(ModalConfirmDeleteAccount);
